...
export function findBestMatch(query: string): string {
  ...
  if (
    ...
    return "Nuestro equipo de soporte está disponible en hola@dinvbox.es o al teléfono +34 644 783 622. También puedes visitar nuestra página de contacto para agendar una llamada."
  }
