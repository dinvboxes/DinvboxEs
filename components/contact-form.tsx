...
export default function ContactForm() {
  ...
  // Inicializar EmailJS con clave pública desde variables de entorno
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_email: "hola@dinvbox.es, davor.ken@icloud.com", // Ambos destinatarios
      }
      ...
      await emailjs.send(serviceID, templateID, templateParams, process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || "")
    ...
    <form onSubmit={handleSubmit} className="space-y-4" aria-label="Formulario de contacto">
      ...
      {submitStatus === "success" && (
        <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded">
          Mensaje enviado correctamente a hola@dinvbox.es. Nos pondremos en contacto contigo
          lo antes posible.
        </div>
      )}
