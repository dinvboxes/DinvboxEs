...
import { Calendar, Clock, ArrowLeft, Share2, Bookmark, Facebook, Twitter, Linkedin, ArrowRight } from "lucide-react"
...
const blogPosts = [
  ...
  {
    id: "conoce-dinvbox-duerme-tranquilo",
    slug: "conoce-dinvbox-y-duerme-tranquilo",
    title: "Conoce DINVBOX y duerme tranquilo",
    excerpt:
      "Cumplir con la Ley Antifraude ya no es una opción. A partir de Julio de 2025, todos los sistemas de facturación deben garantizar inalterabilidad, trazabilidad, firma digital y conservación verificable de cada factura.",
    date: "16 JUNIO, 2025",
    readTime: "4 min",
    image: "/images/blog/dinvbox-duerme-tranquilo.jpeg",
    category: "DINVBOX",
    author: {
      name: "Equipo DINVBOX",
      role: "Especialistas en Cumplimiento Fiscal",
      avatar: "/images/dinvbox-logo.png",
    },
    content: `
      <p>Cumplir con la Ley Antifraude ya no es una opción. A partir de Julio de 2025, todos los sistemas de facturación deben garantizar inalterabilidad, trazabilidad, firma digital y conservación verificable de cada factura. La Agencia Tributaria permite dos vías: optar por un sistema conectado con VERI*FACTU o asumir internamente todo el cumplimiento técnico. La diferencia no es solo legal, es operativa.</p>
      
      <h2>Cumplir sin complicaciones: la ventaja de DINVBOX</h2>
      
      <p>DINVBOX ha sido diseñado desde su núcleo para cumplir de forma natural con la normativa, integrando VERI*FACTU de forma nativa y sin añadir complejidad para el usuario. Nuestro enfoque combina automatización, seguridad y soporte personalizado para que puedas concentrarte en lo esencial: tu negocio.</p>
      
      <ul>
        <li><strong>Cumplimiento automático y en tiempo real.</strong> Tus registros se validan y envían directamente a la AEAT.</li>
        <li><strong>Sin fricciones técnicas.</strong> El sistema está preparado para que emitas facturas sin preocuparte por los requisitos de firma o trazabilidad.</li>
        <li><strong>Soporte humano y cercano.</strong> Un equipo especializado te acompaña siempre que lo necesites.</li>
        <li><strong>Modelo flexible y justo.</strong> Sin cuotas mensuales, solo pagas por los envíos que realizas.</li>
      </ul>
      
      <h2>¿Y si optas por un sistema sin VERI*FACTU?</h2>
      
      <p>El modelo alternativo, aunque legal, implica una carga técnica considerable:</p>
      
      <ul>
        <li>Generación de XML firmados para cada factura</li>
        <li>Implementación de medidas de bloqueo, trazabilidad y conservación inalterable</li>
        <li>Garantía de exportabilidad y auditabilidad ante la AEAT</li>
        <li>Mayor exposición en caso de inspección o error de implementación</li>
      </ul>
      
      <p>En resumen: más riesgo, más coste y menos tranquilidad.</p>
      
      <h2>Una decisión estratégica para tu tranquilidad fiscal</h2>
      
      <p>Con DINVBOX, cumples de forma sencilla, segura y transparente. Te acompañamos en cada paso y te damos las herramientas para crecer sin miedo a sanciones ni complicaciones técnicas.</p>
      
      <p><strong>Evita líos. Factura con DINVBOX.</strong></p>
      
      <p><a href="https://dinvbox.es" target="_blank" rel="noopener noreferrer">dinvbox.es</a></p>
    `,
  },
  {
    id: "julio-sin-lios-verano",
    slug: "julio-sin-lios-factura-facil-y-disfruta-tu-verano",
    title: "Julio sin líos: factura fácil y disfruta tu verano",
    excerpt:
      "Julio trae calor y ganas de desconexión, pero también la tranquilidad de dejar todo en orden antes de tus vacaciones. Aquí tienes lo que debes presentar este mes como autónomo o emprendedor en España.",
    date: "01 JULIO, 2025",
    readTime: "5 min",
    image: "/images/blog/julio-sin-lios-verano.jpeg",
    ...
    content: `
      <p>Julio trae calor y ganas de desconexión, pero también la tranquilidad de dejar todo en orden antes de tus vacaciones. Aquí tienes, de forma clara y directa, lo que debes presentar este mes como autónomo o emprendedor en España para estar listo para el verano:</p>
      
      <h2>IRPF trimestral (Modelo 130 o 131)</h2>
      
      <p>Si tributas en estimación directa, presenta el Modelo 130. Si estás en módulos, el Modelo 131.</p>
      
      <ul>
        <li><strong>Fecha límite:</strong> 21 de julio.</li>
        <li><strong>Si domicilias el pago:</strong> hasta el 16 de julio.</li>
      </ul>
      
      <h2>IVA trimestral (Modelo 303)</h2>
      
      <p>Declara el IVA repercutido menos el soportado.</p>
      ...
      <h2>Retenciones (Modelos 111 y 115)</h2>
      
      <ul>
        <li><strong>Modelo 111:</strong> retenciones a trabajadores o profesionales.</li>
        <li><strong>Modelo 115:</strong> retenciones por alquiler de locales.</li>
        <li><strong>Fecha límite:</strong> 21 de julio.</li>
        <li><strong>Si domicilias el pago:</strong> hasta el 16 de julio.</li>
      </ul>
      
      <h2>Impuesto sobre Sociedades (Modelo 200)</h2>
      
      <p>Si tienes una sociedad limitada, presenta la declaración anual.</p>
      
      <ul>
        <li><strong>Fecha límite:</strong> 25 de julio.</li>
      </ul>
      
      <h2>Con DINVBOX VERI*FACTU, todo bajo control</h2>
      
      <p>Con Dinvbox VERI*FACTU, tu facturación y obligaciones fiscales quedan al día sin complicaciones, para que lo único que te ocupe este verano sea decidir dónde pasar tu próximo atardecer.</p>
      
      <p>Descubre cómo Dinvbox te ayuda a dejar todo listo y disfrutar un verano sin preocupaciones fiscales.</p>
      
      <p><strong>¡Disfruta tu verano con la tranquilidad de tener todo en orden!</strong></p>
    `,
  },
]
        ...
        <>
          ...
          <section className="py-16 bg-gray-50">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h2 className="font-heading text-2xl font-bold text-navy-900 mb-8">Artículos relacionados</h2>
                ...
                {relatedPosts.map((relatedPost) => (
                  ...
                  >
                    <Link href={`/blog/${relatedPost.slug}`} className="block">
                      ...
                      <div>
                        <span className="text-sm font-medium text-orange-500">{relatedPost.category}</span>
