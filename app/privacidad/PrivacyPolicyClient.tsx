        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none prose-headings:font-heading prose-headings:text-navy-900 prose-a:text-orange-500">
            ...
            <p>
              ...
              <strong>Plaza de las Cortes 5, P5, 28014 Madrid (España)</strong>, y correo electrónico de
              contacto: <a href="mailto:hola@dinvbox.es">hola@dinvbox.es</a> (en adelante,{" "}
            ...
            <p>
              ...
              <a href="mailto:hola@dinvbox.es">hola@dinvbox.es</a>, y nuestro equipo atenderá su
              petición.
            </p>
